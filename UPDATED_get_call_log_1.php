public function get_call_log_1()
{
        ...
        if (!empty($check_user)) {
            ...
            if (!empty($get_dates)) {
                ...
                foreach ($get_dates as $g) {
                    ...
                    $wh_1 = '(uid="' . $uid . '" AND date="' . $date . '" AND flag = 1 AND call_type = 2)';
                    $list_1 = $this->Api_Model->getAllData_as_group_order(
                        'calling_details',
                        $wh_1,
                        'friend_id',
                        'id desc'
                    ...
                    foreach ($list_1 as $l_1) {
                        ...
                        if (!empty($user)) {
                            ...
                            $themeColor = !empty($user['themeColor'])
                                ? $user['themeColor']
                                : '#00A3E9';
                        ...
                        $last_cal = $this->Api_Model->getSingleLimitData(
                            ...
                            '(uid="' . $uid . '" AND friend_id="' . $friend_id . '" 
                              AND flag = 1 AND date="' . $date . '" AND call_type = 2)',
                            'id desc'
                        );
                        ...
                        $check_call_log = $this->Api_Model->getAllData_as_per_order(
                            'calling_details',
                            '(uid="' . $uid . '" AND friend_id="' . $friend_id . '" 
                              AND date="' . $date . '" AND flag = 1 AND call_type = 2)',
                            'id desc'
                        );
