...
class ApiService {
    ...
    // MARK: - Fetch Theme Color (matching Android fetchThemeColor in Webservice.java)
    static func fetch_theme_color(uid: String, completion: @escaping (Bool, String, String?) -> Void) {
