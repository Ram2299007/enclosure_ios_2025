...
// Call history list - matching Android voice_call_history_row.xml (simple, no CardView)
...
// Call history row - matching Android voice_call_history_row.xml (simple, no CardView)
struct CallHistoryRowView: View {
    ...
    var body: some View {
        // Android: marginHorizontal="40dp", marginTop="4dp", marginBottom="21dp", gravity="center_vertical"
        HStack(spacing: 0) {
            // calling_flag_icon: 17x15dp
            Image(iconImageName)
                .resizable()
                .renderingMode(.template)
            ...
            // Vertical layout: marginStart="16dp"
            ...
            // incomingCallTotal: duration text on the right (gray color)
        ...
        .padding(.horizontal, 40) // marginHorizontal="40dp"
        .padding(.top, 4)         // marginTop="4dp"
        .padding(.bottom, 21)     // marginBottom="21dp"
    }
}
