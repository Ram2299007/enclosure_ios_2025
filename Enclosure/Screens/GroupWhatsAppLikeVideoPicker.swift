//
//  GroupWhatsAppLikeVideoPicker.swift
//  Enclosure
//
...
struct GroupWhatsAppLikeVideoPicker: View {
    ...
    init(maxSelection: Int = 5, group: GroupModel, onVideosSelected: @escaping ([PHAsset], String) -> Void) {
    ...
    private func loadAllVideos() {
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            ...
            DispatchQueue.main.async {
                print("🎥 [GroupWhatsAppVideoPicker] Loaded \(assets.count) videos")
